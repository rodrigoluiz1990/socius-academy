...
- **Telas que utilizam os dados desta tela:** Dispositivo de acesso e Caixa.
- **Relatórios que utilizam os dados desta tela como filtro:** Relatório consolidado de dispositivo, Relatório detalhado de dispositivo, Relatório caixa consolidado, Relatório detalhado de movimento de caixa, Relatório consolidado de ticket médio e Relatório consolidado de valores em circulação.
